...
void ata_dump_id(u16 *id)
{
	...
	printk("Product model number: %s\n\r", product);

	/* Total sectors of device  */
	n_sectors = ata_id_n_sectors(id);
	printk("Capablity: %d sectors\n\r", n_sectors);

	printk ("id[49]: capabilities = 0x%04x\n"
	...
	printk ("id[76]: sata capablity = 0x%04x\n"
	...
	printk ("id[80]: major version = 0x%04x\n"
		...
		id[83],
		id[84]);
	printk ("id[85]: command set enable 1 = 0x%04x\n"
