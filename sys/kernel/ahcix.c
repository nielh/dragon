...
static inline void  *ahci_port_base(void  *base, u32 port)
{
	return base + 0x100 + (port * 0x80);
}


static void ahci_setup_port(struct ahci_ioports *port, void  *base,
...
static int waiting_for_cmd_completed(void  *offset,
				     int timeout_msec,
				     u32 sign)
{
	int i;
...
static void sunxi_dma_init(void  *port_mmio)
{
...
static int wait_spinup(void  *port_mmio)
{
	ulong start;
	u32 tf_data;
